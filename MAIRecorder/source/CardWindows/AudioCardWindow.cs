...
namespace MAIRecorder {
    public partial class AudioCardWindow : Form {
        ...
        IDataSinkTarget m_dsTarget = null;
        ...
        SignalEdge m_ct0SignalEdge;
        SignalEdge m_ct1SignalEdge;
        CounterResolution m_ct0Resolution;
        CounterResolution m_ct1Resolution;
        ...
        bool m_Out0Sinus = true;
        bool m_Out1Sinus = true;
        int m_Out0TMChannel = -1;
        int m_Out1TMChannel = -1;
     
        string m_Out0TMHeaderfile = "";
        string m_Out1TMHeaderfile = "";
        double m_Out0SineFreq = 440;
        double m_Out1SineFreq = 440;
        double m_Out0SineAmplitude = 5;
        double m_Out1SineAmplitude = 5;

        double[] m_Out0Buffer = null;
        double[] m_Out1Buffer = null;
